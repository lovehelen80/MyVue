...
using Abp.Threading;
using MyVue.Web.Configuration;
using MyVue.Web.Configuration.Ui;
using MyVue.Web.Sessions;
using MyVue.Web.Web.Models;
using MyVue.Web.Web.Models.Layout;

namespace MyVue.Web.Web.Controllers
{
    public class LayoutController : WebControllerBase
    {
